...
/**
 *  project
 * project case:   This is a  project index file
 *
 * @version     $Id: index.php {REVISION} 2015-04-17_00h53m41s biyi $
 * @package     Platform
 * @category    Tests
 * @author      Platform
 * @link        mailto:platform@entilda.com
 * @copyright   Copyright (C) 2011 - 2015 The Platform Authors. All rights reserved.
