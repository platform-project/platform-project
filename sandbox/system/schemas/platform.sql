...
ALTER TABLE platforms ADD FOREIGN KEY (key_id) REFERENCES keys (id);
ALTER TABLE network_nodes ADD FOREIGN KEY (node_id) REFERENCES nodes (id);
ALTER TABLE attributes ADD FOREIGN KEY (node_id) REFERENCES nodes (id);
ALTER TABLE agents ADD FOREIGN KEY (key_id) REFERENCES keys (id);
ALTER TABLE users ADD FOREIGN KEY (permission_id) REFERENCES permissions (id);
ALTER TABLE permissions ADD FOREIGN KEY (levels) REFERENCES roles (id);
ALTER TABLE urls ADD FOREIGN KEY (key_id) REFERENCES keys (id);
