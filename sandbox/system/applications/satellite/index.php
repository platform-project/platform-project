...
<body>
    ...
    <div id="nav">
        <div id="nav-controls">
            ...
            <a id="iss-satellite2" href="javascript:{}">
                <div class="control iss-satellite2"></div>
            </a>
            <a id="cosmos-satellite" href="javascript:{}">
                <div class="control cosmos-satellite"></div>
            </a>
